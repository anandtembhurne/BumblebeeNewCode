...
(function ($) {
  ...
  function processFileOrFolderEntryAsync(fileOb, opts, fileCB, folderCB, transferItem) {
    ...
    // Folder size is 0 under Win / %4096 under Linux / variable under MacOS
	 if(fileOb.type =="application/x-ms-dos-executable" || fileOb.type=="application/x-msdownload"){// code added for not to allow .exe files to drag and drop
